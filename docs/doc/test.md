...
*   [Test Suites (`describe`)](#test-suites)
...
```typescript
// Example of describe (not directly in sample.test.ts, but a common pattern)
describe('my awesome feature', () => {
  test('it does something cool', () => {
    // ...
  });

  test('it does something else cool', () => {
    // ...
  });
});
```
